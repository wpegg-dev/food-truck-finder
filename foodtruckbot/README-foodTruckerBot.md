# FoodTrucker Bot - `foodTruckerBot`
...
3. Give the bot a handle (ex: `foodTruckerBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://foodtruckbot.azurewebsites.net/api/messages`
